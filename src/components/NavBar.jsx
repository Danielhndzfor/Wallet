...
function NavBar() {
    return (
        <nav>
            <div className="fixed bottom-3 left-0 right-0 bg-slate-200 text-white flex justify-around z-50 m-2 rounded-5 ">
                <a href="#" className="flex flex-col items-center text-decoration-none mt-2">
                    <svg
                ...
                <a
                    href="/home"
                    className="flex flex-col  items-center text-blue-500 text-decoration-none mt-2"
                >
